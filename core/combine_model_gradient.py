...
class CombineModel_w_gradientAE(nn.Module):
    ...
    def forward(self, left_hdr, right_hdr, initial_exp, iters=32):
        ...
        #* 2. GradientAE
        exp_gradientAE = self.gradient_AE.gradient_exposure_control(ldr_left_exph_cap)
        ...
        return disp_predictions, exp_gradientAE, left_hdr, captured_rand_img_list, captured_adj_img_list