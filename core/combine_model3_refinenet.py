...
class CombineModel_wo_net(nn.Module):
    ...
    def forward(self, left_hdr, right_hdr, left_next_hdr, right_next_hdr, initial_exp_high, initial_exp_low, iters=32):
        ...
        exp1, exp2 = stereo_exposure_control7(initial_exp_high, initial_exp_low, histo_ldr1, histo_ldr2, alpha1=self.alpha_values, alpha2=self.alpha_values, exp_gap_threshold=2.0)
