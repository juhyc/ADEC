...
from core.disp_recon_model_refine_wo_mask import RAFTStereoFusion_refine_wo_mask
...
class CombineModel_wo_net_wo_mask(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.args = args

        self.disp_recon_net = RAFTStereoFusion_refine_wo_mask(args)
