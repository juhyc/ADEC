...
class RealDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return [self.image_list[index], self.image_list[index + 1]], left1_rect, right1_rect, left2_rect, right2_rect
...
def fetch_real_dataloader(args):
    ...
    if 'test_real' in args.train_datasets:
        test_dataset = RealDataset(root='datasets/Real', image_set='test', test_date_folder='08_22_15_38')
