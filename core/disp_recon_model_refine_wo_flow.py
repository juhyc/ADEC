...
class RAFTStereoFusion_refine_wo_flow(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.args = args
    ...
    def forward(self, image1, image2, image1_next, image2_next, iters=32, flow_init=None, test_mode=False):
        ...
        resized_image1_next_mask = self.resize_soft_binary_mask(image1_next_mask, fmap1)
        resized_image2_next_mask = self.resize_soft_binary_mask(image2_next_mask, fmap2)
        ...
        fused_fmap1 = (resized_image1_mask * fmap1 + resized_image1_next_mask * fmap2)/mask_sum_safe1
        fused_fmap2 = (resized_image2_mask * fmap2 + resized_image2_next_mask * fmap2)/mask_sum_safe2
        ...
        # # # *Refine feature map
        # refined_fmap1 = fused_fmap1.clone()
        # refined_fmap1 = torch.where(resized_image1_mask > resized_image1_next_mask, fused_fmap1, self.refine_net(fused_fmap1))
        # refined_fmap2 = fused_fmap2.clone()
        # refined_fmap2 = torch.where(resized_image2_mask > resized_image2_next_mask, fused_fmap2, self.refine_net(fused_fmap2))
        ...
        # 첫 번째 이미지에서 나온 cnet feature map
            ...
            fused_fmap_08 = (resized_image1_mask_08 * cnet_list1[0][0] + resized_image1_next_mask_08 * cnet_list1_next[0][0]) / mask_sum_safe_08
            ...
            fused_fmap_16 = (resized_image1_mask_16 * cnet_list1[1][0] + resized_image1_next_mask_16 * cnet_list1_next[1][0]) / mask_sum_safe_16
            ...
            fused_fmap_32 = (resized_image1_mask_32 * cnet_list1[2][0] + resized_image1_next_mask_32 * cnet_list1_next[2][0]) / mask_sum_safe_32
